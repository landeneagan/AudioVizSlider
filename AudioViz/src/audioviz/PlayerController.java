...
//        lengthText.setText(duration.toString());
        lengthText.setText(durString.substring(0, durString.indexOf(".")+2) + " ms");
//      Added Code end
...
//        currentText.setText(Double.toString(ms));
        currentText.setText(ctString.substring(0, ctString.indexOf(".")+2) + " ms");
//      Added Code end
...
//  Added Code start
    @FXML
    private void handleSlider(Event event) {
        Duration duration = mediaPlayer.getTotalDuration();
        Double durConvert = duration.toMillis();
        mediaPlayer.seek(duration.multiply(timeSlider.getValue()/durConvert));
    }
//  Added Code end
    @FXML
